...
<img src="{{ site.url }}/images/vitoria.jpeg" width="320">{: .image-pull-right} _**Vitória**_ has a degree in Biotechnology by Universidade Federal de São Carlos (USFCar). 
